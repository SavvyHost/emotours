        ...
        (n = [
            ...
            function (t, e, n) {
                ...
                (t.exports = function (t, e) {
                    ...
                    license:
                        "https://github.com/zloirock/core-js/blob/v3.24.0/LICENSE",
            ...
            function (M, t, e) {
                ...
                function eo(t, e) {
                    ...
                    var n = (function t(e) {
                        ...
                        i = T(n),
                        i = t
                            ? [i].concat(i.visualViewport || [], to(n) ? n : [])
                            : n,
                        n = e.concat(i);
                ...
                function so(t, e) {
                    var i,
                        ...
                        a = oo(
                            xi(a)
                                ? a
                                : a.contextElement || Di(t.elements.popper),
                            o,
                            r
                        ),
                        ...
                        w &&
                            (d &&
                                ...
                                (o = m
                                    ...
                                    : _ + l + i + h.mainAxis),
                                (m = (n =
                                    u.elements.arrow && Pi(u.elements.arrow))
                                    ? "y" === b
                                        ? n.clientTop || 0
                                        : n.clientLeft || 0
                                    : 0),
                ...
                class Fo extends g {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            if (!t.defaultPrevented && e) {
                                "tooltip" === this.constructor.NAME &&
                                    this.tip &&
                                    this.getTitle() !==
                                        this.tip.querySelector(Mo).innerHTML &&
                                    (this._disposePopper(),
                                    this.tip.remove(),
                                    (this.tip = null));
                    ...
                    _enter(t, e) {
                        (e = this._initializeOnDelegatedTarget(t, e)),
                            t &&
                                (e._activeTrigger[
                                    "focusin" === t.type ? Wo : Bo
                                ] = !0),
                            e.getTipElement().classList.contains(jo) ||
                            e._hoverState === Po
                                ? (e._hoverState = Po)
                ...
                class wa extends _ {
                    constructor(t, e) {
                        super(t, e),
                            (this._config = this._getConfig(e)),
                            (this._parent = wa.getParentFromElement(
                                this._element
                            )),
                            (this._menuStyle = ""),
                    ...
                    _autoInit(e) {
                        if (
                            ...
                            if (
                                ...
                                "span" === n.tagName.toLowerCase() &&
                                    n.classList.contains(P))
                            )
                                this._element = n;
                            else {
                                ...
                                e &&
                                    ...
                                    this._element &&
                                        ...
                                        this._isMinWidthSet &&
                                            ...
                                            (this._isMinWidthSet = !1)),
                                        this._rippleInSpan &&
                                        this._element.classList.contains(Oa)
