...
<section class="secondary_nav sticky_horizontal">
   <div class="mdc-tab-bar " role="tablist"> 
      <div class="mdc-tab-scroller ">
        ...
        <a  href="#description" class="mdc-tab mdc-tab--active" role="tab" aria-selected="true" tabindex="-1">
          <span class="mdc-tab__content">
            <span class="mdc-tab__icon material-icons md-button__icon" aria-hidden="true">favorite</span>
        ...
        @if(!empty($title))
        <a href="#included-excluded" class="mdc-tab" role="tab" aria-selected="true" tabindex="-1">
          <span class="mdc-tab__content">
            <span class="mdc-tab__icon material-icons md-button__icon" aria-hidden="true">favorite</span>
        ...
        <a href="#suggestion" class="mdc-tab" role="tab" aria-selected="true" tabindex="6">
          <span class="mdc-tab__content">
